...
//Initiates Storybook for DayList element
const days = [
  {
    id: 1,
    name: "Monday",
...
storiesOf("DayList", module)
  .addParameters({
    backgrounds: [{ name: "dark", value: "gray", default: true }],
  })
  .add("Monday", () => (
...
//Initiates Storybook for InterviewerListItem element
const interviewer = {
  id: 1,
  name: "Sylvia Palmer",
...
//Initiates Storybook for InterviewerList element
const interviewers = [
...
storiesOf("InterviewerList", module)
  ...
  //Initiates Storybook for Appointment element
